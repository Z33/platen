...
exports.sourceNodes = ({ actions, schema }) => {
  ...
  actions.createTypes([
    ...
    interface MdxBookChapter @nodeInterface {
      id: ID!
      slug: String!
      lastUpdated: Date! @dateformat
    ...
    type BookChapter implements Node & MdxBookChapter @dontInfer @childOf(type: "Mdx") {
      id: ID!
      slug: String! @proxyResolve(from: "parent.slug")
      title: String! @proxyResolve(from: "parent.frontmatter.title")
      chapter: String! @proxyResolve(from: "parent.frontmatter.chapter")
    ...
    type Author implements Node & MdxAuthor {
      id: ID!
      slug: String! @proxyResolve(from: "parent.slug")
      ...
      posts: [Frontmatter] @link(by: "frontmatter.author", from: "author")
    }
    `,
  ])
}
...
exports.onCreateNode = ({ node, actions, getNode, createNodeId }) => {
  ...
  if (parent.sourceInstanceName === "book") {
    const regexBook = RegExp(/^.*?\/(index\.mdx)/, "g")

    if (regexBook.test(parent.relativePath)) {
      actions.createNode({
      ...
      actions.createNode({
        id: createNodeId(`Book-Ch-${node.id}`),
        parent: node.id,
        internal: {
          type: "BookChapter",
          contentDigest: node.internal.contentDigest,
